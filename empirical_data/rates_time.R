...
source("[PATH_TO_SCRIPT]/rates_time_functions.R")
...
# process data into right form (function dt from rates_time_functions.R)
# with metadata
...
# (relative_fit function from rates_time_functions.R)
...
# (adequate function from rates_time_functions.R)
...
# bind data and choose variables from metadata (nn is changed to mean population nn)
# (bind function from rates_time_functions.R)
