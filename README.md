...
__Responsibility:__ VBK is responsible for writing code and analysis of data. KLV has contributed with ideas and comments. The time series data is downloaded from the [PETS database](https://pets.nhm.uio.no/). 
